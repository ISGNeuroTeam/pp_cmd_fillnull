...
class FillnulCommand(BaseCommand):
    ...
    def transform(self, df: pd.DataFrame) -> pd.DataFrame:
        self.log_progress('Start fillnul command')
        ...
        self.logger.debug(f'Command fillnul get first positional argument = {first_positional_string_argument}')
        self.logger.debug(f'Command fillnul get keyword argument = {kwarg_int_argument}')
